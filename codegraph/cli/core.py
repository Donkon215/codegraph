...
# Extracted commands are registered from sub-modules to keep core lean.

from codegraph.cli.architecture import COMMANDS as _arch_cmds
from codegraph.cli.governance import COMMANDS as _gov_cmds, GROUPS as _gov_groups
from codegraph.cli.intelligence import COMMANDS as _intel_cmds, GROUPS as _intel_groups
from codegraph.cli.runtime import COMMANDS as _rt_cmds, GROUPS as _rt_groups

for _cmd in _arch_cmds + _gov_cmds + _intel_cmds + _rt_cmds:
    main.add_command(_cmd)

for _grp in _gov_groups + _intel_groups + _rt_groups:
